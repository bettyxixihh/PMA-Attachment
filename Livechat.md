# Live chat 
Adapted from: https://suturf.com/simple-chat-using-python-flask-api/

## PYTHON SERVER
creating an instance of new Flask application and SocketIO
...
We have to maintain a list of users who have joined the chat and also what rooms they belong to
